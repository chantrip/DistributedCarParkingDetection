...
class MiniAlexnetTrainProperties:
    ...
    def GetTrainSettingsValue(cls,index):
        args=[]
        if index ==0:
            args = [0.0001,0.9,0.0001,False,"KERAS_Weights_CNR_Parks_tuned_lr1dc1.h5"]
        elif index==1:
            args = [0.0001,0.9,0.0005,False,"KERAS_Weights_CNR_Parks_tuned_lr1dc5.h5"]
        elif index==2:
            args = [0.0004,0.9,0.0001,False,"KERAS_Weights_CNR_Parks_tuned_lr4dc1.h5"]
        elif index==3:
            args = [0.0004,0.9,0.0005,False,"KERAS_Weights_CNR_Parks_tuned_lr4dc5.h5"]
        elif index==4:
            args = [0.0008,0.9,0.0001,False,"KERAS_Weights_CNR_Parks_tuned_lr8dc1.h5"]
        elif index==5:
            args = [0.0008,0.9,0.0005,False,"KERAS_Weights_CNR_Parks_tuned_lr8dc5.h5"]
